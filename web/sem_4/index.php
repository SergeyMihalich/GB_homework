      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <?php for ($i=0; $i < count($skills); $i++): ?>
              <p><?=$skills[$i]['name']; ?></p>present
              <div class="w3-light-grey w3-round-xlarge w3-small">
                <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?=$skills[$i]['present']; ?>%"><?=$skills[$i]['present']; ?>%</div>
              </div>
          <?php endfor; ?>
          <br>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php for ($i=0; $i < count($job); $i++): ?>
          <h5 class="w3-opacity"><b><?=$job['job_name'][$i]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$job['job_data'][$i]; ?></h6>
          <p><?=$job['job_desc'][$i]; ?></p>
          <hr>
        <?php endfor; ?>
      </div>
